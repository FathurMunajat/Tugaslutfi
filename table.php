...
<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSuppor
tedContent"
...
<li class="nav-item">
<a href="tambahdata.php" tabindex="0" class="btn btn-lg btn-danger" role="button" data-bs-toggle="popover" data-bs-trigger="focus"
...
<td>
<a href="delete.php?id=<?= $student["id"]?>"onclick="return confirm('yakin nih mau di hapus ga sayang?')">hapus</a>
</td>
<td>
<a href="update.php?id=<?= $student["id"]?>"onclick="return confirm('yakin nih mau di hapus ga sayang?')">ubah</a>
</td>
</tr>
<?php $i++; ?>
<?php endforeach; ?>
